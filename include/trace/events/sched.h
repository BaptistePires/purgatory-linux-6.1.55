...
TRACE_EVENT(sched_purgatory_update_stats,
	TP_PROTO(unsigned long nr_removed),
	TP_ARGS(nr_removed),
	TP_STRUCT__entry(
		__field(unsigned long, nr_removed)
	),

	TP_fast_assign(
		__entry->nr_removed = nr_removed;
	),

	TP_printk("%lu", __entry->nr_removed)
);

TRACE_EVENT(sched_purgatory_clear_stats,
	TP_PROTO(unsigned long nr_removed),
	TP_ARGS(nr_removed),
	TP_STRUCT__entry(
		__field(unsigned long, nr_removed)
